...
exports.Brickyard = void 0;
const is_obj_util_js_1 = require("./is-obj.util.js");
/**
 * @description
 * ### How to use:
 * #### Minimal example:
          ...
          const merged =
            (args.length > intercepted_args.length ? args : intercepted_args)
              .map((_, i) => {
                ...
                const a = args[i];
                if (
                  (0, is_obj_util_js_1.is_obj)(a) &&
                  (0, is_obj_util_js_1.is_obj)(intercepted_a)
                ) {
